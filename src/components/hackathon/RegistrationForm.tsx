...
const registrationSchema = z.object({
  ...
  github_url: z.string().trim().url("Please enter a valid GitHub URL").min(1, "GitHub URL is required"),
  linkedin_url: z.string().trim().url("Please enter a valid LinkedIn URL").min(1, "LinkedIn URL is required"),
